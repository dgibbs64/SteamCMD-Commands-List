...
sort "${rootdir}/tmp/commands_list_raw.txt" | xargs | tee "${rootdir}/tmp/commands_list_sort.txt"
...
sort "${rootdir}/tmp/convars_list_raw.txt"  | xargs | tee "${rootdir}/tmp/convars_list_sort.txt"
