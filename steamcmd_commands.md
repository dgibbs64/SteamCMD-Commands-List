...
nClientBackgroundAutoUpdateRecentlyPlayedThresholdHours = "168"        : If you've played the game more recently than this, we'll schedule the background update sooner.
   nClientBackgroundAutoUpdateTargetHour = "6"          : Target hour, in local time, for auto-scheduled app updates. Will be spread around this point via the convar below.
